...
sin_cell_ordering_class_2 <- function(cycle_data, celltime_levels,
                                    ...
                                    n_cores=1)
{
  ...
  while (TRUE) {
    estimates <- sin_cell_ordering_iter_2(cycle_data=cycle_data,
    ...
    beta1_iter <- estimates$beta1_iter
    beta2_iter <- estimates$beta2_iter
    ...
    for(index in 1:num_shuffle) {
      fun <- sin_cell_ordering_iter_2(cycle_data=cycle_data,
                                    celltime_levels=celltime_levels,
      ...
      beta1_iter <- fun$beta1_iter
      beta2_iter <- fun$beta2_iter
